  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 text-lg py-6 px-8 rounded-2xl font-semibold shadow-lg hover:shadow-xl",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90",
        glass: "bg-card/50 backdrop-blur-xl border border-border/50 text-foreground hover:bg-card/70",
        flag: "bg-card/80 backdrop-blur-xl border-2 border-border/50 hover:border-primary text-4xl p-6 rounded-2xl transition-all duration-300",
      },
      size: {
